---
name: to-tasks
description: Break a plan, spec, or PRD into independently-grabbable tasks using tracer-bullet vertical slices. Use when user wants to convert a plan into tasks, create implementation tasks, or break down work into actionable items.
---
...
For each approved slice, create a task in `design/TASKS.md`. Use the body template below to capture task details.
